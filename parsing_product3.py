...
filenameproduct = 'result/results_product_url7.csv'
...
chromedrivers = "selen3\chromedriver.exe"
FILE_NAMES = 'sites/site3.html'
FILE_NAMES2 = 'sites/sites_page/site{}.html'
fail_url_files = 'fail/fail_url3.csv'
