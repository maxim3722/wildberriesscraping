...
filenameproduct = 'result/results_product_urlTest.csv'
...
FILE_NAMES = 'sites/site1.html'
FILE_NAMES2 = 'sites/sites_page/site{}.html'
fail_url_files = 'fail/fail_url1.csv'
...
def connect(number_file):
    ...
    #dtList-comments-count c-text-sm"
    try:
        with open(FILE_NAMES2.format(number_file), 'r', encoding='utf8') as f:
           ...
           print(len(list_comment),len(list_tag_a))
           for a in list_tag_a:
