...
filenameproduct = 'result/results_product_urlEndFileTwo.csv'
...
chromedrivers = "selen2\chromedriver.exe"
FILE_NAMES = 'sites/site2.html'
FILE_NAMES2 = 'sites/sites_page/site{}.html'
fail_url_files = 'fail/fail_url2.csv'
    ...
    try:
        with open(FILE_NAMES2.format(number_file), 'r', encoding='utf8') as f:
           ...
           for a in list_tag_a:
               ...
               number_comment = a.find('span',{'class':'dtList-comments-count c-text-sm'})
               if number_comment != None and int(number_comment.text) > 50:
